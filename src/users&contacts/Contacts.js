...
const contacts = [{picture: grandma, name:"grandma"},
                  {picture: avocado, name:"Dan"},
                  {picture: defauldImg, name:"Gil"},
                  {picture: defauldImg, name:"Maya"},
                  {picture: defauldImg, name:"Shir"}]
